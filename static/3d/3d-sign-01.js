...
var o3dSign = (function () {
  ...
  function init() {
    ...
    var keyMap = [targets.table, targets.sphere, targets.helix, targets.grid];
    var currentIndex = 0;

    function getIndex(len) {
      //下标算法
      return (currentIndex % len + len) % len;
    }
    $(document).keydown(function (event) {
      ...
      if (event.keyCode == 32) {
        currentIndex++;
        console.log(keyMap[getIndex(4)]);
        transform(keyMap[getIndex(4)], 2000)　　　　
      }　　
    });
